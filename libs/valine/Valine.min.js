    ...
    (n = [
      ...
      function (e, t, n) {
        ...
        (t.parseTag = function (e, t, n) {
            ...
            if (!1 === s) "<" === d && (s = c);
              ...
              if ("<" === d) (a += n(e.slice(u, c))), (u = s = c);
                ...
                (a += n(e.slice(u, s))),
                  ...
                  (i = void 0),
                  (i = v.spaceIndex(o)),
                  (o = -1 === i ? o.slice(1, -1) : o.slice(1, i + 1)),
                  (f = o =
                    "/" ===
                    (o =
                      "/" === (o = v.trim(o).toLowerCase()).slice(0, 1)
                        ? o.slice(1)
                        : o).slice(-1)
                      ? o.slice(0, -1)
                      : o),
                  (a += t(s, a.length, f, r, "</" === r.slice(0, 2))),
                  (u = c + 1),
                  (s = !1);
              else if ('"' === d || "'" === d)
                for (
                  var h = 1, g = e.charAt(c - h);
                  "" === g.trim() || "=" === g;
          ...
          return u < e.length && (a += n(e.substr(u))), a;
        }),
          (t.parseAttr = function (e, n) {
            "use strict";
            function t(e, t) {
              (e = (e = v.trim(e)).replace(p, "").toLowerCase()).length < 1 ||
                ((e = n(e, t || "")) && o.push(e));
            }
                  ...
                  /\s|\n|\t/.test(l) &&
                    ...
                    !1 === i
                      ? -1 ===
                        ...
                        ? (t(v.trim(e.slice(r, u))), (i = !1), (r = u + 1))
                        : (u = s - 1)
                      : -1 ===
                          (s = (function (e, t) {
                            for (; 0 < t; t--) {
                        ...
                        (t(i, c(v.trim(e.slice(r, u)))),
                        (i = !1),
                        (r = u + 1)));
                else {
                  if (-1 === (s = e.indexOf(l, u + 1))) break;
                  t(i, v.trim(e.slice(r + 1, s))), (i = !1), (r = (u = s) + 1);
                }
              else (i = e.slice(r, u)), (r = u + 1);
            }
            return (
              r < e.length &&
                (!1 === i ? t(e.slice(r)) : t(i, c(v.trim(e.slice(r))))),
              v.trim(o.join(" "))
            );
          });
      },
              ...
              b = function (e, t, n) {
                var r = (0, L.default)(
                  ...
                  a = e.get("link")
                    ...
                    : "",
                  u = L.default.escape(
                    (0, U.default)(e.get("nick").substring(0, 20))
                  ),
                  a = a
